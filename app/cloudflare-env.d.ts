/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv cloudflare-env.d.ts` (hash: b56cfd051357450389075b1ea7998cdb)
// Runtime types generated with workerd@1.20260409.1 2026-03-01 nodejs_compat
declare namespace Cloudflare {
	interface Env {
		...
		VIDEO_API_USER_ID: string;
		VIDEO_API_PASSWORD: string;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "GOOGLE_SHEET_ID" | "GOOGLE_SERVICE_ACCOUNT_KEY_JSON" | "VIDEO_API_BASE_URL" | "VIDEO_API_USER_ID" | "VIDEO_API_PASSWORD">> {}
}
